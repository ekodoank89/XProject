...
fun MapsScreen(
    ...
    Box(modifier = modifier.fillMaxSize()) {
        ...
        GoogleMap(
            ...
            // ===== Lingkaran radius jitter GJK (bisa disembunyikan dari OPT) =====
            if (uiState.isGjkRadiusCircleVisible) {
            ...
            // ===== Titik jitter GRB: bergerak live (bisa disembunyikan dari OPT) =====
            if (uiState.isGrbJitterDotVisible) {
                uiState.grbJitterPosition?.let {
                    MarkerComposable(
                        state = grbDotState,
                        title = "JITTER GRB",
            ...
            // ===== Titik jitter GJK: bergerak live (bisa disembunyikan dari OPT) =====
            if (uiState.isGjkJitterDotVisible) {
                uiState.gjkJitterPosition?.let {
                    MarkerComposable(
                        state = gjkDotState,
                        title = "JITTER GJK",
